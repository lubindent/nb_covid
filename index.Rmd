---
title: "NB Covid Rates"
author: "Original work by [Gordon Shotwell](https://shotwell.ca/), NB Adaptation by [Justin d'Entremont](mailto:justin5824@gmail.com)"
...
The data comes from [daily reports](http://gnb.ca/coronavirus) from the New Brunswick Provincial Government which are recorded in a [Github Repo](https://github.com/lubindent/nb_covid). Some data has been taken from media reports to fill in blanks in testing numbers prior to March 28th.
...
covid %>% 
  ...
  mutate(group = factor(group, levels = c("total", "active",  "recovered", "in_hospital"),
                        labels = c("Total Cases",  "Active Infections",  "Recovered", "In Hospital"))) %>% 
